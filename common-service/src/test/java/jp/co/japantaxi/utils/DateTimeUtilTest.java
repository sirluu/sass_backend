...
public class DateTimeUtilTest {
	...
	private Timestamp fromTimestamp = DateTimeUtil.getTimestampFromString(fromDateString, DateTimeUtil.DATE_TIME_FM);
	private Timestamp toTimestamp = DateTimeUtil.getTimestampFromString(toDateString, DateTimeUtil.DATE_TIME_FM);
	...
	public void test_getDateFromString_withValue() {
		Assert.assertEquals(DateTimeUtil.getDateFromString(fromDateString, DateTimeUtil.DATE_TIME_FM), fromDate);
	}

	@Test
	public void test_getDateFromString_withValue_returnException() {
		Assert.assertNotEquals(DateTimeUtil.getDateFromString(fromDateString, DateTimeUtil.DATE_TIME_FM), toDate);
	}
	...
	public void test_getStringFromDate_withValue() {
		Assert.assertEquals(DateTimeUtil.getStringFromDate(fromDate, DateTimeUtil.DATE_TIME_FM), fromDateString);
	}
	...
	public void test_getTimestampFromString_returnParseException() {
		Assert.assertEquals(DateTimeUtil.getTimestampFromString("123", DateTimeUtil.DATE_TIME_FM), null);
	}

	@Test
	public void test_getTimestampFromString_withValue() {
		Assert.assertEquals(DateTimeUtil.getTimestampFromString(fromDateString, DateTimeUtil.DATE_TIME_FM),
				fromTimestamp);
	}

	@Test
	public void test_getTimestampFromString_returnException() {
		Assert.assertNotEquals(DateTimeUtil.getTimestampFromString(fromDateString, DateTimeUtil.DATE_TIME_FM),
				toTimestamp);
	}
