...
public class ConvertDataUtilTest {
	...
	public void test_convertJsonObjectToAccount() {
        ...
        Assert.assertEquals(expected.getAffiliationstorenamealphabetic(), ConvertDataUtil.convertJsonObjectToAccount(actual).getAffiliationstorenamealphabetic());
        Assert.assertEquals(expected.getAffiliationstorenamekana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getAffiliationstorenamekana());
        Assert.assertEquals(expected.getAffiliationstorenamekanji(), ConvertDataUtil.convertJsonObjectToAccount(actual).getAffiliationstorenamekanji());
        Assert.assertEquals(expected.getAppcompany(), ConvertDataUtil.convertJsonObjectToAccount(actual).getAppcompany());
        Assert.assertEquals(expected.getCorporatenumber(), ConvertDataUtil.convertJsonObjectToAccount(actual).getCorporatenumber());
        Assert.assertEquals(expected.getInvaliddate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getInvaliddate());
        Assert.assertEquals(expected.getInvaliddetailreason(), ConvertDataUtil.convertJsonObjectToAccount(actual).getInvaliddetailreason());
        Assert.assertEquals(expected.getInvalidreason(), ConvertDataUtil.convertJsonObjectToAccount(actual).getInvalidreason());
        ...
        Assert.assertEquals(expected.getMerchantcontrinforisregistry(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantcontrinforisregistry());
        Assert.assertEquals(expected.getMerchantcontrinforlicenseacquisitiondate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantcontrinforlicenseacquisitiondate());
        Assert.assertEquals(expected.getMerchantcontrinforlicensename(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantcontrinforlicensename());
        Assert.assertEquals(expected.getMerchantcontrinforlicensenumber(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantcontrinforlicensenumber());
        Assert.assertEquals(expected.getMerchantcontrinfortabletmodel(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantcontrinfortabletmodel());
        Assert.assertEquals(expected.getMerchantdeliveryinforaddress(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforaddress());
        Assert.assertEquals(expected.getMerchantdeliveryinforcontactname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforcontactname());
        Assert.assertEquals(expected.getMerchantdeliveryinfordate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinfordate());
        Assert.assertEquals(expected.getMerchantdeliveryinforgakkencustomernumber(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforgakkencustomernumber());
        Assert.assertEquals(expected.getMerchantdeliveryinformemo(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinformemo());
        Assert.assertEquals(expected.getMerchantdeliveryinforname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforname());
        Assert.assertEquals(expected.getMerchantdeliveryinforphone(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforphone());
        Assert.assertEquals(expected.getMerchantdeliveryinforpostalcode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforpostalcode());
        Assert.assertEquals(expected.getMerchantdeliveryinforprefecturecode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantdeliveryinforprefecturecode());
        Assert.assertEquals(expected.getMerchantinfoaddress(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoaddress());
        Assert.assertEquals(expected.getMerchantinfoaddresskana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoaddresskana());
        Assert.assertEquals(expected.getMerchantinfocontactemail(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfocontactemail());
        Assert.assertEquals(expected.getMerchantinfocontactname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfocontactname());
        Assert.assertEquals(expected.getMerchantinfoerroraccountbank(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccountbank());
        Assert.assertEquals(expected.getMerchantinfoerroraccountbranch(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccountbranch());
        Assert.assertEquals(expected.getMerchantinfoerroraccountkana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccountkana());
        Assert.assertEquals(expected.getMerchantinfoerroraccountname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccountname());
        Assert.assertEquals(expected.getMerchantinfoerroraccountnumber(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccountnumber());
        Assert.assertEquals(expected.getMerchantinfoerroraccounttype(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerroraccounttype());
        Assert.assertEquals(expected.getMerchantinfoerrorinquiryemail(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerrorinquiryemail());
        Assert.assertEquals(expected.getMerchantinfoerrorinquiryname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerrorinquiryname());
        Assert.assertEquals(expected.getMerchantinfoerrorinquiryphone(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoerrorinquiryphone());
        Assert.assertEquals(expected.getMerchantinfoinquiryemail(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoinquiryemail());
        Assert.assertEquals(expected.getMerchantinfoinquiryname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoinquiryname());
        Assert.assertEquals(expected.getMerchantinfoinquiryphone(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoinquiryphone());
        Assert.assertEquals(expected.getMerchantinfoisrepresentative(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoisrepresentative());
        Assert.assertEquals(expected.getMerchantinfometerlist(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfometerlist());
        Assert.assertEquals(expected.getMerchantinfopaymentcontactname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfopaymentcontactname());
        Assert.assertEquals(expected.getMerchantinfophonenumberhyphen(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfophonenumberhyphen());
        Assert.assertEquals(expected.getMerchantinfopostalcode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfopostalcode());
        Assert.assertEquals(expected.getMerchantinfoprefecturecode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoprefecturecode());
        Assert.assertEquals(expected.getMerchantinforadename(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinforadename());
        Assert.assertEquals(expected.getMerchantinforemarks(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinforemarks());
        Assert.assertEquals(expected.getMerchantinfoserviceid(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfoserviceid());
        Assert.assertEquals(expected.getMerchantinfowarningemail(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantinfowarningemail());
        Assert.assertEquals(expected.getMerchantoperinforacceptancedate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantoperinforacceptancedate());
        Assert.assertEquals(expected.getMerchantoperinforcontractenddate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantoperinforcontractenddate());
        Assert.assertEquals(expected.getMerchantoperinforguaranteeenddate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantoperinforguaranteeenddate());
        Assert.assertEquals(expected.getMerchantoperinformemo(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantoperinformemo());
        Assert.assertEquals(expected.getMerchantoperinforstartdate(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantoperinforstartdate());
        Assert.assertEquals(expected.getMerchantpayinfoaddress1(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfoaddress1());
        Assert.assertEquals(expected.getMerchantpayinfoaddress2(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfoaddress2());
        Assert.assertEquals(expected.getMerchantpayinfocontactname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfocontactname());
        Assert.assertEquals(expected.getMerchantpayinfoname(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfoname());
        Assert.assertEquals(expected.getMerchantpayinfopostalcode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfopostalcode());
        Assert.assertEquals(expected.getMerchantreprinforaddress(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforaddress());
        Assert.assertEquals(expected.getMerchantreprinforbirthday(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforbirthday());
        Assert.assertEquals(expected.getMerchantreprinforfullnamekana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforfullnamekana());
        Assert.assertEquals(expected.getMerchantreprinforfullnamekanji(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforfullnamekanji());
        Assert.assertEquals(expected.getMerchantreprinformemo(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinformemo());
        Assert.assertEquals(expected.getMerchantpayinfoitabbankaccount(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfoitabbankaccount());
        Assert.assertEquals(expected.getMerchantpayinfonetbankaccount(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantpayinfonetbankaccount());
        Assert.assertEquals(expected.getMerchantreprinforphone(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforphone());
        Assert.assertEquals(expected.getMerchantreprinforpostalcode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforpostalcode());
        Assert.assertEquals(expected.getMerchantreprinforprefecturecode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforprefecturecode());
        Assert.assertEquals(expected.getMerchantreprinforsex(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantreprinforsex());
        Assert.assertEquals(expected.getMerchantstoreinforaddress(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforaddress());
        Assert.assertEquals(expected.getMerchantstoreinforaddresskana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforaddresskana());
        Assert.assertEquals(expected.getMerchantstoreinformemo(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinformemo());
        Assert.assertEquals(expected.getMerchantstoreinforphone(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforphone());
        Assert.assertEquals(expected.getMerchantstoreinforpostalcode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforpostalcode());
        Assert.assertEquals(expected.getMerchantstoreinforprefecturecode(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforprefecturecode());
        Assert.assertEquals(expected.getMerchantstoreinforstorenamealphabet(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforstorenamealphabet());
        Assert.assertEquals(expected.getMerchantstoreinforstorenamehalfwidthkana(), ConvertDataUtil.convertJsonObjectToAccount(actual).getMerchantstoreinforstorenamehalfwidthkana());
	...
	public void test_convertJsonObjectToAppcompany() {
		...
		actual.put("carImageName", "teststring");
		actual.put("carImageColor", "teststring");
		...
		Assert.assertEquals(expected.getAcceptmajor2(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getAcceptmajor2());
		Assert.assertEquals(expected.getAcceptminor2(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getAcceptminor2());
		Assert.assertEquals(expected.getAccount(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getAccount());
		...
		Assert.assertEquals(expected.getCommunicationurl(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getCommunicationurl());
		Assert.assertEquals(expected.getCompanylogoimage(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getCompanylogoimage());
		Assert.assertEquals(expected.getCompanynameen(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getCompanynameen());
		Assert.assertEquals(expected.getDispatchtype(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDispatchtype());
		Assert.assertEquals(expected.getDisplaysalescity(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDisplaysalescity());
		Assert.assertEquals(expected.getDisplaysalescityen(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDisplaysalescityen());
		Assert.assertEquals(expected.getEmail(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getEmail());
		Assert.assertEquals(expected.getExtendedfieldmap(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getExtendedfieldmap());
		Assert.assertEquals(expected.getFaretable(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getFaretable());
		Assert.assertEquals(expected.getGloballat(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getGloballat());
		Assert.assertEquals(expected.getGloballng(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getGloballng());
		Assert.assertEquals(expected.getGroupcompanies(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getGroupcompanies());
		Assert.assertEquals(expected.getInvaliddate(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getInvaliddate());
		Assert.assertEquals(expected.getInvaliddetailreason(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getInvaliddetailreason());
		Assert.assertEquals(expected.getInvalidreason(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getInvalidreason());
		Assert.assertEquals(expected.getIsenableclosing(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getIsenableclosing());
		Assert.assertEquals(expected.getIsexternalcancel(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getIsexternalcancel());
		Assert.assertEquals(expected.getIsradionumberedit(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getIsradionumberedit());
		Assert.assertEquals(expected.getLogoimage(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getLogoimage());
		Assert.assertEquals(expected.getMinutestowaitforpickup(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getMinutestowaitforpickup());
		Assert.assertEquals(expected.getName(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getName());
		Assert.assertEquals(expected.getNetpaytypes(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getNetpaytypes());
		Assert.assertEquals(expected.getOrdercancelurl(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getOrdercancelurl());
		Assert.assertEquals(expected.getOrderurl(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getOrderurl());
		Assert.assertEquals(expected.getPartnerapiversion(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPartnerapiversion());
		Assert.assertEquals(expected.getPaymentmethod(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPaymentmethod());
		Assert.assertEquals(expected.getPaymentmethoden(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPaymentmethoden());
		Assert.assertEquals(expected.getPhonenumber(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPhonenumber());
		Assert.assertEquals(expected.getPhonenumbercancel(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPhonenumbercancel());
		Assert.assertEquals(expected.getPickupfeedescription(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPickupfeedescription());
		Assert.assertEquals(expected.getProfile(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getProfile());
		Assert.assertEquals(expected.getRatingaverage(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getRatingaverage());
		Assert.assertEquals(expected.getReplywatingminute(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getReplywatingminute());
		Assert.assertEquals(expected.getSalescity(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getSalescity());
		Assert.assertEquals(expected.getArea(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getArea());
		Assert.assertEquals(expected.getAreacode(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getAreacode());
		Assert.assertEquals(expected.getSalesprefecture(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getSalesprefecture());
		Assert.assertEquals(expected.getSalesprefectureen(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getSalesprefectureen());
		Assert.assertEquals(expected.getShowbookingcancel(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowbookingcancel());
		Assert.assertEquals(expected.getShowdest(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowdest());
		Assert.assertEquals(expected.getShowemptycar(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowemptycar());
		Assert.assertEquals(expected.getShowimmediatecancel(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowimmediatecancel());
		Assert.assertEquals(expected.getShowminutestowaitforpickup(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowminutestowaitforpickup());
		Assert.assertEquals(expected.getShowmoving(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowmoving());
		Assert.assertEquals(expected.getShowmustarrivaltime(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowmustarrivaltime());
		Assert.assertEquals(expected.getShowvisit(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getShowvisit());
		Assert.assertEquals(expected.getStatus(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getStatus());
		Assert.assertEquals(expected.getSfid(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getSfid());
		Assert.assertEquals(expected.getWaitforpickupdefault(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getWaitforpickupdefault());
		Assert.assertEquals(expected.getWarningemail(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getWarningemail());
		Assert.assertEquals(expected.getDrivercontract(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDrivercontract());
		Assert.assertEquals(expected.getImplementationcosts(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getImplementationcosts());
		Assert.assertEquals(expected.getMonthlyminimumcars(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getMonthlyminimumcars());
		Assert.assertEquals(expected.getMonthlyminimumcharge(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getMonthlyminimumcharge());
		Assert.assertEquals(expected.getPayablecommission(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getPayablecommission());
		Assert.assertEquals(expected.getRemarks(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getRemarks());
		Assert.assertEquals(expected.getRequestcompanyidrelation(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getRequestcompanyidrelation());
		Assert.assertEquals(expected.getBankaccount(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getBankaccount());
		Assert.assertEquals(expected.getBankaccount2(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getBankaccount2());
		Assert.assertEquals(expected.getWww(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getWww());
		Assert.assertEquals(expected.getDestinationaddress(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDestinationaddress());
		Assert.assertEquals(expected.getDestinationcompanyname(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDestinationcompanyname());
		Assert.assertEquals(expected.getDestinationcontactname(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDestinationcontactname());
		Assert.assertEquals(expected.getDestinationpostalcode(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDestinationpostalcode());
		Assert.assertEquals(expected.getDestinationprefecture(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getDestinationprefecture());
		Assert.assertEquals(expected.getRequeststartdate(), ConvertDataUtil.convertJsonObjectToAppCompany(actual).getRequeststartdate());
	}
	...
	public void test_convertJsonObjectToBankAccountInformation() {
		...
		Assert.assertNotEquals(expected, ConvertDataUtil.convertJsonObjectToBankAccountInformation(actual));
	...
	public void test_convertJsonObjectToPaymentSystemLinkInfor() {
		...
		Assert.assertNotEquals(expected, ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual));
		Assert.assertEquals(expected.getServiceid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getServiceid());
		Assert.assertEquals(expected.getTofacemerchantid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofacemerchantid());
		Assert.assertEquals(expected.getNontofacemerchantid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofacemerchantid());
		Assert.assertEquals(expected.getLinepaychannelsecret(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getLinepaychannelsecret());
		Assert.assertEquals(expected.getLinepaychannelid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getLinepaychannelid());
		Assert.assertEquals(expected.getLastmodifieddate(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getLastmodifieddate());
		Assert.assertEquals(expected.getInternetpaymerstore(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getInternetpaymerstore());
		Assert.assertEquals(expected.getTofacepaymentrouteid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofacepaymentrouteid());
		Assert.assertEquals(expected.getNontofacepaymentrouteid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofacepaymentrouteid());
		Assert.assertEquals(expected.getTofacehashkey(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofacehashkey());
		Assert.assertEquals(expected.getNontofacehashkey(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofacehashkey());
		Assert.assertEquals(expected.getTofaceencryptkey(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofaceencryptkey());
		Assert.assertEquals(expected.getNontofaceencryptkey(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofaceencryptkey());
		Assert.assertEquals(expected.getTofaceencryptiv(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofaceencryptiv());
		Assert.assertEquals(expected.getNontofaceencryptiv(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofaceencryptiv());
		Assert.assertEquals(expected.getTofacecardtype(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofacecardtype());
		Assert.assertEquals(expected.getNontofacecardtype(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofacecardtype());
		Assert.assertEquals(expected.getTofacebasicauthpassword(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getTofacebasicauthpassword());
		Assert.assertEquals(expected.getNontofacebasicauthpassword(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getNontofacebasicauthpassword());
		Assert.assertEquals(expected.getAupaystoreid(), ConvertDataUtil.convertJsonObjectToPaymentSystemLinkInfor(actual).getAupaystoreid());
	}
	...
	public void test_convertJsonObjectToBankMaster() {
		...
		expected.setLastmodifieddate(DateTimeUtil.getTimestampFromString("01:01:01", DateTimeUtil.DD_FM));
		...
		Assert.assertEquals(expected.getName(), ConvertDataUtil.convertJsonObjectToBankMaster(actual).getName());
	...
	public void test_convertJsonObjectToFareTable() {
		...
		Assert.assertEquals(expected.getSfid(), ConvertDataUtil.convertJsonObjectToFareTable(actual).getSfid());
