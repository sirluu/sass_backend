...
public class ConvertDataUtil {
  ...
  public static Account convertJsonObjectToAccount(JSONObject jsonObject) {
    ...
    account.setAffiliationstorenamekana(
        jsonObject.get("aSNameKana").toString().replace("{}", "").trim());
    account.setAffiliationstorenamekanji(
        jsonObject.get("aSNameKanji").toString().replace("{}", "").trim());
    account.setAppcompany(jsonObject.get("appCompany").toString().replace("{}", "").trim());
    account
        .setCorporatenumber(jsonObject.get("corporateNumber").toString().replace("{}", "").trim());
    account.setInvaliddate(DateTimeUtil.getDateFromString(
        jsonObject.get("invalidDate").toString().replace("{}", "").trim(), DateTimeUtil.DD_FM));
    account.setInvaliddetailreason(
        jsonObject.get("invalidDetailReason").toString().replace("{}", "").trim());
    ...
    account.setKeirino(
        Utility.parseInt(jsonObject.get("keiri_no").toString().replace("{}", "").trim()));
    ...
    account.setMerchantcontrinforapplicationdate(DateTimeUtil.getTimestampFromString(
        jsonObject.get("mCIApplicationDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DATE_TIME_FM));
    account.setMerchantcontrinforisfacetofacesettlement(Utility.parseBoolean(
        jsonObject.get("mCIIsFacetofaceSettlement").toString().replace("{}", "").trim()));
    ...
    account.setMerchantdeliveryinforaddress(
        jsonObject.get("mDIAddress").toString().replace("{}", "").trim());
    ...
    account.setMerchantdeliveryinformemo(
        jsonObject.get("mDIMemo").toString().replace("{}", "").trim());
    account.setMerchantdeliveryinforname(
        jsonObject.get("mDIName").toString().replace("{}", "").trim());
    account.setMerchantdeliveryinforphone(
        jsonObject.get("mDIPhone").toString().replace("{}", "").trim());
    ...
    account.setMerchantinfoaddresskana(
        jsonObject.get("mIAddressKana").toString().replace("{}", "").trim());
    account.setMerchantinfocontactemail(
        jsonObject.get("mIContactEmail").toString().replace("{}", "").trim());
    account.setMerchantinfocontactname(
        jsonObject.get("mIContactName").toString().replace("{}", "").trim());
    ...
    account.setMerchantinfoinquiryemail(
        jsonObject.get("mIInquiryEmail").toString().replace("{}", "").trim());
    account.setMerchantinfoinquiryname(
        jsonObject.get("mIInquiryName").toString().replace("{}", "").trim());
    account.setMerchantinfoinquiryphone(
        jsonObject.get("mIInquiryPhone").toString().replace("{}", "").trim());
    account.setMerchantinfoisrepresentative(Utility
        .parseBoolean(jsonObject.get("mIIsRepresentative").toString().replace("{}", "").trim()));
    account.setMerchantinfometerlist(
        jsonObject.get("mIMeterList").toString().replace("{}", "").trim());
    ...
    account.setMerchantinfopostalcode(
        jsonObject.get("mIPostalCode").toString().replace("{}", "").trim());
    account.setMerchantinfoprefecturecode(
        jsonObject.get("mIPrefectureCode").toString().replace("{}", "").trim());
    account
        .setMerchantinforadename(jsonObject.get("mIradeName").toString().replace("{}", "").trim());
    account.setMerchantinforemarks(jsonObject.get("mIRemarks").toString().replace("{}", "").trim());
    account.setMerchantinfoserviceid(
        jsonObject.get("mIServiceID").toString().replace("{}", "").trim());
    account.setMerchantinfowarningemail(
        jsonObject.get("mIWarningEmail").toString().replace("{}", "").trim());
    account.setMerchantoperinforacceptancedate(DateTimeUtil.getDateFromString(
        jsonObject.get("mOIAcceptanceDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DD_FM));
    account.setMerchantoperinforcontractenddate(DateTimeUtil.getDateFromString(
        jsonObject.get("mOIContractEndDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DD_FM));
    account.setMerchantoperinforguaranteeenddate(DateTimeUtil.getDateFromString(
        jsonObject.get("mOIGuaranteeEndDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DD_FM));
    account.setMerchantoperinformemo(jsonObject.get("mOIMemo").toString().replace("{}", "").trim());
    account.setMerchantoperinforstartdate(DateTimeUtil.getDateFromString(
        jsonObject.get("mOIStartDate").toString().replace("{}", "").trim(), DateTimeUtil.DD_FM));
    ...
    account.setMerchantpayinfoitabbankaccount(
        jsonObject.get("mPayInfoItabBAcc").toString().replace("{}", "").trim());
    account.setMerchantpayinfonetbankaccount(
        jsonObject.get("mPayInfoNetBAcc").toString().replace("{}", "").trim());
    account
        .setMerchantpayinfoname(jsonObject.get("mPayInfoName").toString().replace("{}", "").trim());
    account.setMerchantpayinfopostalcode(
        jsonObject.get("mPayInfoPostalCode").toString().replace("{}", "").trim());
    account.setMerchantreprinforaddress(
        jsonObject.get("mRIAddress").toString().replace("{}", "").trim());
    account.setMerchantreprinforbirthday(DateTimeUtil.getDateFromString(
        jsonObject.get("mRIBirthday").toString().replace("{}", "").trim(), DateTimeUtil.DD_FM));
    ...
    account
        .setMerchantreprinforphone(jsonObject.get("mRIPhone").toString().replace("{}", "").trim());
    ...
    account.setMerchantstoreinforaddress(
        jsonObject.get("mSIAddress").toString().replace("{}", "").trim());
    account.setMerchantstoreinforaddresskana(
        jsonObject.get("mSIAddressKana").toString().replace("{}", "").trim());
    account
        .setMerchantstoreinformemo(jsonObject.get("mSIMemo").toString().replace("{}", "").trim());
    account
        .setMerchantstoreinforphone(jsonObject.get("mSIPhone").toString().replace("{}", "").trim());
    ...
    account.setLastmodifieddate(DateTimeUtil.getTimestampFromString(
        jsonObject.get("lastMDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DATE_TIME_FM));
    account.setSfid(jsonObject.get("sfid").toString().replace("{}", "").trim());

    account.setWebsite(jsonObject.get("website").toString().replace("{}", "").trim());
    account.setAppcompanyid(
        Utility.parseInt(jsonObject.get("appCompanyID").toString().replace("{}", "").trim()));
  ...
  public static AppCompany convertJsonObjectToAppCompany(JSONObject jsonObject) {
    ...
    appCompany.setJtxcompanyid(
        Utility.parseInt(jsonObject.get("jtxCompanyID").toString().replace("{}", "").trim()));
    appCompany
        .setAppdisplayname(jsonObject.get("appDisplayName").toString().replace("{}", "").trim());
    ...
    appCompany
        .setCars(Utility.parseInt(jsonObject.get("cars").toString().replace("{}", "").trim()));
    appCompany.setClosingtimeto(DateTimeUtil.getTimestampFromString(
        jsonObject.get("closingTimeTo").toString().replace("{}", "").trim(),
        DateTimeUtil.TIME_FM_S));
    appCompany.setClosingtimefrom(DateTimeUtil.getTimestampFromString(
        jsonObject.get("closingTimeFrom").toString().replace("{}", "").trim(),
        DateTimeUtil.TIME_FM_S));
    appCompany.setCommunicationurl(
        jsonObject.get("communicationUrl").toString().replace("{}", "").trim());
    appCompany.setCompanylogoimage(
        jsonObject.get("companyLogoImage").toString().replace("{}", "").trim());
    appCompany
        .setCompanynameen(jsonObject.get("companyNameEN").toString().replace("{}", "").trim());

    appCompany.setDestinationaddress(jsonObject.get("desAddr").toString().replace("{}", "").trim());
    appCompany.setDestinationcompanyname(
        jsonObject.get("desCompName").toString().replace("{}", "").trim());
    appCompany.setDestinationcontactname(
        jsonObject.get("desContName").toString().replace("{}", "").trim());
    appCompany.setDestinationpostalcode(
        jsonObject.get("desPostCode").toString().replace("{}", "").trim());
    appCompany
        .setDestinationprefecture(jsonObject.get("desPrefec").toString().replace("{}", "").trim());
    appCompany.setDispatchtype(jsonObject.get("dispatchType").toString().replace("{}", "").trim());
    appCompany.setDisplaysalescity(
        jsonObject.get("displaySalesCity").toString().replace("{}", "").trim());
    appCompany.setDisplaysalescityen(
        jsonObject.get("displaySalesCityEN").toString().replace("{}", "").trim());
    appCompany.setEmail(jsonObject.get("email").toString().replace("{}", "").trim());
    appCompany.setExtendedfieldmap(
        jsonObject.get("extendedFieldMap").toString().replace("{}", "").trim());
    ...
    appCompany.setInvaliddate(DateTimeUtil.getDateFromString(
        jsonObject.get("invalidDate").toString().replace("{}", "").trim(), DateTimeUtil.DD_FM));
    appCompany.setInvaliddetailreason(
        jsonObject.get("invalidDetailReason").toString().replace("{}", "").trim());
    appCompany
        .setInvalidreason(jsonObject.get("invalidReason").toString().replace("{}", "").trim());
    appCompany.setIsenableclosing(Utility
        .parseBoolean(jsonObject.get("isEnableClosing").toString().replace("{}", "").trim()));
    appCompany.setIsexternalcancel(Utility
        .parseBoolean(jsonObject.get("isExternalCancel").toString().replace("{}", "").trim()));
    appCompany.setIsradionumberedit(Utility
        .parseBoolean(jsonObject.get("isRadioNumberEdit").toString().replace("{}", "").trim()));
    ...
    appCompany
        .setOrdercancelurl(jsonObject.get("orderCancelUrl").toString().replace("{}", "").trim());
    ...
    appCompany
        .setPaymentmethod(jsonObject.get("paymentMethod").toString().replace("{}", "").trim());
    appCompany
        .setPaymentmethoden(jsonObject.get("payMethodEN").toString().replace("{}", "").trim());
    appCompany.setPhonenumber(jsonObject.get("phoneNumber").toString().replace("{}", "").trim());
    appCompany.setPhonenumbercancel(
        jsonObject.get("phoneNumberCancel").toString().replace("{}", "").trim());
    ...
    appCompany
        .setSalesprefecture(jsonObject.get("salesPrefecture").toString().replace("{}", "").trim());
    appCompany
        .setSalesprefectureen(jsonObject.get("salesPrefeEN").toString().replace("{}", "").trim());
    appCompany.setShowbookingcancel(Utility
        .parseBoolean(jsonObject.get("showBookingCancel").toString().replace("{}", "").trim()));
    appCompany.setShowdest(
        Utility.parseBoolean(jsonObject.get("showDest").toString().replace("{}", "").trim()));
    appCompany.setShowemptycar(
        Utility.parseBoolean(jsonObject.get("showEmptyCar").toString().replace("{}", "").trim()));
    appCompany.setShowimmediatecancel(Utility
        .parseBoolean(jsonObject.get("showImmediateCancel").toString().replace("{}", "").trim()));
    appCompany.setShowminutestowaitforpickup(Utility.parseBoolean(
        jsonObject.get("showMinutesToWaitForPickUp").toString().replace("{}", "").trim()));
    appCompany.setShowmoving(
        Utility.parseBoolean(jsonObject.get("showMoving").toString().replace("{}", "").trim()));
    appCompany.setShowmustarrivaltime(Utility
        .parseBoolean(jsonObject.get("showMustArrivalTime").toString().replace("{}", "").trim()));
    ...
    appCompany.setWaitforpickupdefault(Utility
        .parseInt(jsonObject.get("waitForPickUpDefault").toString().replace("{}", "").trim()));
    appCompany.setWarningemail(jsonObject.get("warningEmail").toString().replace("{}", "").trim());
    appCompany
        .setDrivercontract(jsonObject.get("driverContract").toString().replace("{}", "").trim());
    appCompany.setImplementationcosts(Utility
        .parseInt(jsonObject.get("implementationCosts").toString().replace("{}", "").trim()));
    appCompany.setMonthlyminimumcars(
        Utility.parseInt(jsonObject.get("monthlyMinimumCars").toString().replace("{}", "").trim()));
    appCompany.setMonthlyminimumcharge(Utility
        .parseInt(jsonObject.get("monthlyMinimumCharge").toString().replace("{}", "").trim()));
    ...
    appCompany.setRequestcompanyidrelation(Utility
        .parseInt(jsonObject.get("requestCompanyIDRelation").toString().replace("{}", "").trim()));
    appCompany.setRequeststartdate(DateTimeUtil.getDateFromString(
        jsonObject.get("requestStartDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DD_FM));
    return appCompany;
  }
  ...
  public static AppCompany convertAppCompany2Sync(AppCompany appCompany, boolean sync) {
    ...
    appCompany
        .setPhonenumbercancel(appCompany.getPhonenumbercancel().replace("-", "").replace("_", ""));
    appCompany.setCompanylogoimage(appCompany.getCompanylogoimage()
        .substring(appCompany.getCompanylogoimage().lastIndexOf('/') + 1));
  ...
  public static BankAccountInformation convertJsonObjectToBankAccountInformation(
    ...
    bankAccountInformation
        .setAccount(jsonObject.get("account").toString().replace("{}", "").trim());
    bankAccountInformation
        .setAppcompany(jsonObject.get("appcompany").toString().replace("{}", "").trim());
    bankAccountInformation
    ...
    bankAccountInformation.setInvaliddate(DateTimeUtil.getDateFromString(
        jsonObject.get("invalidDate").toString().replace("{}", "").trim(), DateTimeUtil.DD_FM_S));
    bankAccountInformation
        .setInvalidreason(jsonObject.get("invalidReason").toString().replace("{}", "").trim());
    ...
    bankAccountInformation
        .setAppcompanyid(jsonObject.get("compnayID").toString().replace("{}", "").trim());
  ...
  public static BankAccountInformation convertBankAccountInformation2Sync(
    ...
    if (sync) {
      bankAccountInformation.setSyncedtime(
          Timestamp.valueOf(LocalDateTime.now(DateTimeUtil.TIMEZONE_TOKYO.toZoneId())));
    }
  ...
  public static BankMaster convertJsonObjectToBankMaster(JSONObject jsonObject) {
    ...
    bankMaster
        .setBranchnamekana(jsonObject.get("branchNameKana").toString().replace("{}", "").trim());
  ...
  public static FareTable convertJsonObjectToFareTable(JSONObject jsonObject) {
    ...
    fareTable.setBookingfeedescription(
        jsonObject.get("bookingFeeDesc").toString().replace("{}", "").trim());
    fareTable.setBookingfeeexistence(Utility
        .parseBoolean(jsonObject.get("bookingFeeExistence").toString().replace("{}", "").trim()));
    fareTable.setFirstsquaredistance(Utility
        .parseInt(jsonObject.get("firstSquareDistance").toString().replace("{}", "").trim()));
    ...
    fareTable.setLastmodifieddate(DateTimeUtil.getTimestampFromString(
        jsonObject.get("lastMDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DATE_TIME_FM));
    fareTable.setLatenightearlymorningextra(Utility.parseInt(
        jsonObject.get("lateNightEarlyMorningExtra").toString().replace("{}", "").trim()));
    fareTable.setPickupfare(
        Utility.parseInt(jsonObject.get("pickupFare").toString().replace("{}", "").trim()));
    fareTable.setPickupfeedescription(
        jsonObject.get("pickupFeeDesc").toString().replace("{}", "").trim());
    fareTable.setPickupfeeexistence(Utility
        .parseBoolean(jsonObject.get("pickupFeeExistence").toString().replace("{}", "").trim()));
  ...
  public static PaymentSystemLinkInfor convertJsonObjectToPaymentSystemLinkInfor(
    ...
    linkInforc.setTofacebasicauthid(
        jsonObject.get("toFaceBasicAuthId").toString().replace("{}", "").trim());
    linkInforc.setNontofacebasicauthid(
        jsonObject.get("nonToFaceBasicAuthId").toString().replace("{}", "").trim());

    linkInforc.setTofacebasicauthpassword(
        jsonObject.get("toFaceBasicAuthPassword").toString().replace("{}", "").trim());
    linkInforc.setNontofacebasicauthpassword(
        jsonObject.get("nonToFaceBasicAuthPassword").toString().replace("{}", "").trim());

    linkInforc
        .setTofacecardtype(jsonObject.get("toFaceCardType").toString().replace("{}", "").trim());
    linkInforc.setNontofacecardtype(
        jsonObject.get("nonToFaceCardType").toString().replace("{}", "").trim());

    linkInforc
        .setTofaceencryptiv(jsonObject.get("toFaceEncryptIV").toString().replace("{}", "").trim());
    linkInforc.setNontofaceencryptiv(
        jsonObject.get("nonToFaceEncryptIV").toString().replace("{}", "").trim());

    linkInforc.setTofaceencryptkey(
        jsonObject.get("toFaceEncryptKey").toString().replace("{}", "").trim());
    linkInforc.setNontofaceencryptkey(
        jsonObject.get("nonToFaceEncryptKey").toString().replace("{}", "").trim());

    linkInforc
        .setTofacehashkey(jsonObject.get("toFaceHashKey").toString().replace("{}", "").trim());
    linkInforc.setNontofacehashkey(
        jsonObject.get("nonToFaceHashKey").toString().replace("{}", "").trim());

    linkInforc.setInternetpaymerstore(
        jsonObject.get("internetPayMerStore").toString().replace("{}", "").trim());
    linkInforc.setLastmodifieddate(DateTimeUtil.getTimestampFromString(
        jsonObject.get("lastMDate").toString().replace("{}", "").trim(),
        DateTimeUtil.DATE_TIME_FM));
    linkInforc.setLinepaychannelsecret(
        jsonObject.get("linePayChannelSecret").toString().replace("{}", "").trim());
    linkInforc.setLinepaychannelid(
        jsonObject.get("linePayChannelId").toString().replace("{}", "").trim());

    linkInforc.setTofacemerchantid(
        jsonObject.get("toFaceMerchantId").toString().replace("{}", "").trim());
    linkInforc.setNontofacemerchantid(
        jsonObject.get("nonToFaceMerchantId").toString().replace("{}", "").trim());

    linkInforc.setTofacepaymentrouteid(Utility
        .parseInt(jsonObject.get("toFacePaymentRouteId").toString().replace("{}", "").trim()));
    linkInforc.setNontofacepaymentrouteid(Utility
        .parseInt(jsonObject.get("nonToFacePaymentRouteId").toString().replace("{}", "").trim()));
