...
public class WorkerControllerTest {
	...
	public void test_valid_startmode_exception() {
		...
		Assert.assertEquals(400, workerController.validParameter(parameterRequest).getStatusCode().value());
	}
	...
	public void test_validparameter() {
		...
		parameterRequest.setProcessMode(Constant.PROCESSMODE.GETSF.value);
		parameterRequest.setStartTime("2020-01-01 01:01:01");
		Assert.assertEquals(200, workerController.validParameter(parameterRequest).getStatusCode().value());
	}
	...
	public void test_manual_getsf_synchronize() throws Exception {
		...
		workerController.synchronize(parameterRequest);

		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("http://localhost:8888/stockholm/synchronize")
	...
	public void test_manual_null_synchronize() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.post("http://localhost:8888/stockholm/synchronize").accept(MediaType.APPLICATION_JSON).content("{\r\n"
						+ " \"startMode\": \"manual\",\r\n" + " \"startTime\": \"2020-01-13 11:30:01\"\r\n" + "}")
				.contentType(MediaType.APPLICATION_JSON);
		mockMvc.perform(requestBuilder).andReturn();
	}
